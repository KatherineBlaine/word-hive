...
const Game = ({ data, userWords, updateUserWords, score, updateScore, level, updateLevel }) => {
    ...
    <>
      ...
      <div className="game-page">
        ...
        <div className="score-board">
          <Score userWords={userWords} letters={letters} score={score} updateScore={updateScore} totalPossible={data.total} level ={level} updateLevel={updateLevel}/>
        </div>
      </div>
    </>
  )
